...
D. Analysis copy + cuts  (built and stabilized)
   ...
   PySceneDetect AdaptiveDetector + ThresholdDetector, min_scene_len ≈ 0.5s (detection spacing, not usable duration). start_in_scene=True. Soft dissolves are not trusted to PySceneDetect alone.
